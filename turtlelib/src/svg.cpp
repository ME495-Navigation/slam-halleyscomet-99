...
namespace turtlelib
{
    ...
    std::string Svg::write() const {
        ...
        ss << "<svg width=\"8.5in\" height=\"11in\" viewBox=\"0 0 816 1056\" xmlns=\"http://www.w3.org/2000/svg\">\n";
        
        // Marker definition for arrows
        ss << "<defs>\n";
        ss << "  <marker id=\"arrowhead\" markerWidth=\"10\" markerHeight=\"7\" refX=\"0\" refY=\"3.5\" orient=\"auto\">\n";
