...
namespace turtlelib
{
    ...
    static_assert(almost_equal(normalize_angle(std::numbers::pi), std::numbers::pi), "norm_angle pi failed");
    static_assert(almost_equal(normalize_angle(-std::numbers::pi), std::numbers::pi), "norm_angle -pi failed");
    static_assert(almost_equal(normalize_angle(6.0 * std::numbers::pi), 0.0), "norm_angle > 5pi failed");
    static_assert(almost_equal(normalize_angle(-6.0 * std::numbers::pi), 0.0), "norm_angle < -5pi failed");
    static_assert(almost_equal(normalize_angle(-std::numbers::pi / 4.0), -std::numbers::pi / 4.0), "norm_angle -pi/4 failed");
    static_assert(almost_equal(normalize_angle(1.5 * std::numbers::pi), -0.5 * std::numbers::pi), "norm_angle 3pi/2 failed");
    static_assert(almost_equal(normalize_angle(-2.5 * std::numbers::pi), -0.5 * std::numbers::pi), "norm_angle -5pi/2 failed");
    static_assert(almost_equal(normalize_angle(std::numbers::pi + 0.0001), -std::numbers::pi + 0.0001), "norm_angle wrap failed");
